...
_sage_const_16000 = Integer(16000); _sage_const_1 = Integer(1); _sage_const_10 = Integer(10); _sage_const_0 = Integer(0); _sage_const_1e5 = RealNumber('1e5')
import numpy as np
...
deg = [_sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_1 ]
...
with open(TEX_DIR+'/bezout_exact.txt', 'w') as f:
    ...
    bezout_exact_dim = rank(XBBY[_sage_const_0 ])
    f.write("bezout_exact_dim = {0:d}\n".format(bezout_exact_dim))

    K_ortho = XBBY[_sage_const_0 ].kernel().basis_matrix().right_kernel_matrix()
    ...
    XX = []
    for k in range(n):
        xx = KBBN[_sage_const_0 ].solve_right(KBBN[k+_sage_const_1 ])
        XX.append(xx)
